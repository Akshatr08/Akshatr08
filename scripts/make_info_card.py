...
# ===========================================================================
HOST = "akshatr08"   # shown as  akshatr08@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Building CircuitFeed"),
    ("kv", "Focus", "AI Engineering & LLM Apps"),
    ("kv", "Learning", "C++ & Data Structures"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "JS, TS, Python, C++"),
    ("kv", "Frontend", "React, Next.js, Tailwind"),
    ("kv", "Backend", "Supabase, PostgreSQL, Firebase"),
    ("kv", "AI / ML", "Gemini API, Hugging Face, LLMs"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "CircuitFeed -- the AI layer for AI & tech"),
    ("bul", "Sentinel AI -- Top 16, Goldsmiths AI Challenge '26"),
]
